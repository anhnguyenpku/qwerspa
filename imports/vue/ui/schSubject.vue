    ...
    <div class="sch_subject">
        ...
        <el-dialog
            ...
            <el-form :model="schSubjectForm" :rules="rules" ref="schSubjectFormAdd" label-width="120px"
                ...
                <el-row class="pull-right">
                    <el-button @click="dialogAddSchSubject = false, cancel()">{{langConfig['cancel']}}</el-button>
                    <el-button type="primary" @click="saveSchSubject($event)">{{langConfig['save']}}</el-button>
                </el-row>
                <br>
            </el-form>
        </el-dialog>
        ...
        <el-dialog
            ...
            <el-form :model="schSubjectForm" :rules="rules" ref="schSubjectFormUpdate" label-width="120px"
                ...
                <hr style="margin-top: 0px !important;">
                <el-row class="pull-right">
                    <el-button @click="dialogUpdateSchSubject = false ,cancel()">{{langConfig['cancel']}}</el-button>
                    <el-button type="primary" @click="updateSchSubject">{{langConfig['save']}}</el-button>
                </el-row>
                <br>
            </el-form>
        </el-dialog>
