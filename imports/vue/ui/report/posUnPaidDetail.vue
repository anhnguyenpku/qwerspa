<!--suppress ALL -->
<template>
    <div class="posUnPaidDetail-report">
        <a4>
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posUnPaidDetailReport', this.params, this.langConfig, (err, result) => {
        ...
        computed: {
            dataExist() {
                ...
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['unPaidDetail'];
                return data;
            }
        },
        components: {
