<!--suppress ALL -->
<template>
    <div class="blockSummaryUnpaidExpire-report">
        <a4>
            <div slot="header" class="no-print">
                <el-row type="flex" class="row-bg" justify="center">
                    <el-col :span="24">
                        ...
                        <span slot="title">
                            Block Summary Unpaid Expire Report Filter <i class="header-icon el-icon-information"></i>
                        </span>
                                <el-form :inline="true">
                                    <el-row type="flex" class="row-bg" justify="center">
                                        <el-form-item label="Date As">

                                            <el-date-picker
                                                    v-model="params.dateAs"
                                                    type="date"
                                                    placeholder="Select Date As"
                                                    align="right">
                                            </el-date-picker>
                                        </el-form-item>
            ...
            <span slot="content" style="margin: 0px !important;">
                <table class="table table-report-block-summary table-bordered">
                      <caption>
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-6"
                                  ...
                                  <p>ដីការអមជំពាក់ហួសកាលកំណត់តាមប្លុក</p>ប្រចាំខែ {{blockSummaryUnpaidExpire.monthFooter | switchMonthToKh}} ឆ្នាំ {{blockSummaryUnpaidExpire.yearFooter | switchNumMultiToKh}}
                              </div>
                              <div class="col-md-3">
                    ...
                    <tr>
                        ...
                        <th rowspan="2" style="vertical-align: middle; padding: 0px">ទឹកប្រាក់ត្រូវបង់</th>
                        <th rowspan="2" style="vertical-align: middle; padding: 0px">ជំពាក់</th>
                    </tr>
                    <tr>
                    ...
                    <tbody style="margin-bottom: 5px;">
                        <slot v-for="blockData in blockSummaryUnpaidExpire.data">
                            <tr>
                                <td rowspan="3"
                                ...
                                <th rowspan="3"
                                    style="vertical-align: middle">{{blockData.totalBalance | numFormatRiel}}</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                               ...
                               <th>{{blockSummaryUnpaidExpire.grandTotalInvoice | numFormatRiel}}</th>
                               <th colspan="3" style="text-align: right">Total Consumption : </th>
                               <th>{{blockSummaryUnpaidExpire.grandTotalComsumption | numFormatRiel}}</th>
                               <th colspan="3" style="text-align: right">Total Price : </th>
                               <th>{{blockSummaryUnpaidExpire.grandTotalPrice | numFormatRiel}}</th>
                               <th>{{blockSummaryUnpaidExpire.grandTotalMaintenance | numFormatRiel}}</th>
                               <th>{{blockSummaryUnpaidExpire.grandTotalContributionFee | numFormatRiel}}</th>
                               <th>{{blockSummaryUnpaidExpire.grandTotalMaintenance + blockSummaryUnpaidExpire.grandTotalPrice+ blockSummaryUnpaidExpire.grandTotalContributionFee | numFormatRiel}}</th>
                               <th>{{blockSummaryUnpaidExpire.grandTotalBalance | numFormatRiel}}</th>
                    ...
                    <thead>
                        ...
                        <tr>
                            <td colspan="4"
                                style="text-align: center; font-size: 11px;border: 0px !important;">បានឃើញ និង ពិនិត្យត្រឹមត្រូវ<br>បាត់ដំបង ថ្ងៃទី {{blockSummaryUnpaidExpire.dayFooter | switchNumMultiToKh}}    ខែ  {{blockSummaryUnpaidExpire.monthFooter | switchMonthToKh}}   ឆ្នាំ {{blockSummaryUnpaidExpire.yearFooter | switchNumMultiToKh}}   <br><span
                            ...
                            <td colspan="5"
                                style="text-align: center; font-size: 11px;border: 0px !important;">បាត់ដំបង ថ្ងៃទី  {{blockSummaryUnpaidExpire.dayFooter | switchNumMultiToKh}}    ខែ   {{blockSummaryUnpaidExpire.monthFooter | switchMonthToKh}}    ឆ្នាំ  {{blockSummaryUnpaidExpire.yearFooter | switchNumMultiToKh}}   <br><br><b>អ្នកធ្វើតារាង</b><br><br></td>
                        </tr>
                    </thead>
                </table>
...
<script>
    ...
    export default {
        ...
        methods: {
            exportToExcel() {
                Meteor.call('giveMeSaleReportAsExcelFile', this.blockSummaryUnpaidExpire.data, this.blockSummaryUnpaidExpire.total, (err, workbookBuffer) => {
                    if (!err) {
            ...
            handleRun() {
                ...
                Meteor.call('blockSummaryUnpaidExpireReport', this.params, (err, result) => {
                    if (result) {
                        console.log(result);
                        this.blockSummaryUnpaidExpire = result;
                    }
                    this.loading = false;
                });
            }
        ...
        computed: {
            dataExist() {
                return this.blockSummaryUnpaidExpire != undefined;
            }
        },
        components: {
            a4: PageA4
