<!--suppress ALL -->
<template>
    <div class="transfer-payment-summary-report">
        <a4>
            <div slot="header">
                <el-row type="flex" class="no-print row-bg" justify="center">
                    <el-col :span="24">
                        ...
                        <span slot="title">
                           Debt Payment Summary Filter <i class="header-icon el-icon-information"></i>
                        </span>
                                <el-form :inline="true">
            ...
            <span slot="content" style="padding: 10px;">
                        ...
                        <tr style="font-family: 'Khmer OS Battambang';font-size: 12px;">
                          ...
                          <tbody style="font-size:11px;">
                            ...
                            <slot v-for="payment in type.users">
                                ...
                                <slot v-for="date in payment.dates">
                                    ...
                                    <tr style="border-top: 1px solid black;background: #f5f5f5;text-decoration: underline;">
                                        ...
                                        <td class="text-right">{{date.totalByMonthGrandTotal | numFormatRiel}}</td>
                                ...
                                <!--  <tr style="border-top: 1px solid black;background: #f5f5f5;font-weight: bold;font-size: 11px;">
                                     ...
                                     <td class="text-right">{{payment.totalByUserGrandTotal | numFormatRiel}}</td>
                                  ...
                                  <tr style="border-top: 1px solid black;background: #f5f5f5;font-weight: bold;font-size: 11px;text-decoration: underline">
                                    ...
                                    <td class="text-right">{{type.totalByTypeGrandTotal | numFormatRiel}}</td>
                            ...
                            <tr style="border-top: 1px solid black;background: #f5f5f5;font-weight: bold;font-size: 11px;">
                                    ...
                                    <td class="text-right">{{footer.grandTotal | numFormatRiel}}</td>
                ...
                <div class="row">
                    <div class="col-md-12"
                         style="text-align: center;font-family: 'Khmer OS Muol'; font-size: 14px;margin-bottom: 5px;text-decoration: underline">
                            វិក្កយបត្រ ផ្ទេរមក
                        </div>
                </div>
                <table  border="1" style="font-size:11px;width: 100%">
                        ...
                        <tr style="font-family: 'Khmer OS Battambang';font-size: 12px;">
                          ...
                          <tbody style="font-size:11px;">
                            ...
                            <tr style="border-top: 1px solid black;background: #f5f5f5;font-weight: bold;font-size: 11px;">
                                    <td style="font-weight: normal;font-family: 'Khmer OS Muol'">សរុបរួមៈ</td>
                                    <td></td>
                                    <td class="text-center">{{footer2.numberOfInvoice }}</td>
                                    <td class="text-right">{{footer2.waterConsumption | numFormatRiel}}</td>
                                    <td class="text-right">{{footer2.maintenanceFee | numFormatRiel}}</td>
                                    <td class="text-right">{{footer2.contributionFee | numFormatRiel}}</td>
                                    <td class="text-right">{{footer2.total | numFormatRiel}}</td>
                                    <td class="text-right">{{footer2.grandTotal | numFormatRiel}}</td>
                                    <td class="text-right">{{footer2.paidAmount | numFormatRiel}}</td>
                            </tr>
        ...
        methods: {
            ...
            handleRun() {
                ...
                if (date.length > 0) {
                    ...
                    Meteor.call('fetchTransferPaymentSummary', selector,selector, selector2, selector3, (err, result) => {
                        if (result) {
                            debugger;
                            console.log(result);
                            vm.payments = result.content;
                            ...
                            vm.footer = footer;
                            vm.payments2 = result.content2;
                            result.content2.forEach((con) => {
                                con.users.forEach((user) => {
                                    user.dates.forEach((date) => {
                                        date.data.forEach((d) => {
                                            for (let k in d) {
