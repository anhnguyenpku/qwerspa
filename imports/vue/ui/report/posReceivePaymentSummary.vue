<!--suppress ALL -->
<template>
    <div class="posReceivePaymentSummary-report">
        <a4>
...
<img style="width: 70px;height: 70px;float: left !important;"
     ...
     alt="">
                ...
                <tbody style="margin-bottom: 5px;" v-html="receivePaymentHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posReceivePaymentSummaryReport', this.params, this.langConfig, (err, result) => {

                    if (result) {
                        this.receivePaymentHtml = result.receivePaymentHTML;
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['receivePaymentSummary'];
                return data;
            }
        },
        components: {
