<!--suppress ALL -->
<template>
    <div class="posProductionSummmary-report">
        <a4>
...
<div class="row"
  ...
  <p class="row"
     style="text-align: center !important;font-family:'Khmer OS Battambang';font-size: 11 !important;">
                ...
                <tbody style="margin-bottom: 5px;" v-html="productionSummaryHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posProductionSummaryReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
                        this.productionSummaryHtml = result.productionSummaryHTML;
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['productionSummary'];
                return data;
            }
        },
        components: {
