<!--suppress ALL -->
<template>
    <div class="posPayBillSummary-report">
        <a4>
...
<img style="width: 70px;height: 70px;float: left !important;"
     ...
     alt="">
                ...
                <thead style="margin-top: 5px">
                    <tr>
                        <th>{{langConfig['no']}}</th>
                        <th>{{langConfig['vendorName']}}</th>
                        <th>{{langConfig['totalPaid']}}</th>
                        <th>{{langConfig['discount']}}</th>
                        <th>{{langConfig['balanceUnPaid']}}</th>
                    </tr>
                </thead>
                <tbody style="margin-bottom: 5px;" v-html="payBillHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posPayBillSummaryReport', this.params, this.langConfig, (err, result) => {

                    if (result) {
                        this.payBillHtml = result.payBillHTML;
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['payBillSummary'];
                return data;
            }
        },
        components: {
