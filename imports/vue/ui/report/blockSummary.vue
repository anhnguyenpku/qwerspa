            ...
            <div slot="header" class="no-print">
                <el-row type="flex" class="row-bg" justify="center">
                    <el-col :span="24">
                        ...
                        <span slot="title">
                            Block Summary Report Filter <i class="header-icon el-icon-information"></i>
                        </span>
                                <el-form :inline="true">
                                    <el-row type="flex" class="row-bg" justify="center">
            ...
            <span slot="content" style="margin: 0px !important;">
                <table class="table table-report-block-summary table-bordered">
                      <caption>
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-6"
                                  ...
                                  <p>ដីការអមតាមប្លុក</p>ប្រចាំខែ {{blockSummary.monthFooter | switchMonthToKh}} ឆ្នាំ {{blockSummary.yearFooter | switchNumMultiToKh}}
                              </div>
                              <div class="col-md-3">
                    ...
                    <tbody style="margin-bottom: 5px;">
                        <slot v-for="blockData in blockSummary.data">
                            <tr>
                                <td rowspan="3"
                            ...
                            <tr>
                               ...
                               <th>{{blockSummary.grandTotalInvoice | numFormatRiel}}</th>
                               <th colspan="3" style="text-align: right">Total Consumption : </th>
                               <th>{{blockSummary.grandTotalComsumption | numFormatRiel}}</th>
                               <th colspan="3" style="text-align: right">Total Price : </th>
                               <th>{{blockSummary.grandTotalPrice | numFormatRiel}}</th>
                               <th>{{blockSummary.grandTotalMaintenance | numFormatRiel}}</th>
                               <th>{{blockSummary.grandTotalContributionFee | numFormatRiel}}</th>
                               <th>{{blockSummary.grandTotalMaintenance + blockSummary.grandTotalPrice+ blockSummary.grandTotalContributionFee | numFormatRiel}}</th>
                    ...
                    <thead>
                        ...
                        <tr>
                            <td colspan="4"
                                style="text-align: center; font-size: 11px;border: 0px !important;">បានឃើញ និង ពិនិត្យត្រឹមត្រូវ<br>បាត់ដំបង ថ្ងៃទី {{blockSummary.dayFooter | switchNumMultiToKh}}    ខែ  {{blockSummary.monthFooter | switchMonthToKh}}   ឆ្នាំ {{blockSummary.yearFooter | switchNumMultiToKh}}   <br><span
                            ...
                            <td colspan="4"
                                style="text-align: center; font-size: 11px;border: 0px !important;">បាត់ដំបង ថ្ងៃទី  {{blockSummary.dayFooter | switchNumMultiToKh}}    ខែ   {{blockSummary.monthFooter | switchMonthToKh}}    ឆ្នាំ  {{blockSummary.yearFooter | switchNumMultiToKh}}   <br><br><b>អ្នកធ្វើតារាង</b><br><br></td>
                        </tr>
                    </thead>
                </table>
...
<script>
    ...
    export default {
        ...
        methods: {
            exportToExcel() {
                Meteor.call('giveMeSaleReportAsExcelFile', this.blockSummary.data, this.blockSummary.total, (err, workbookBuffer) => {
                    if (!err) {
            ...
            handleRun() {
                ...
                Meteor.call('blockSummaryReport', this.params, (err, result) => {
                    if (result) {
                        console.log(result);
                        this.blockSummary = result;
                    }
                    this.loading = false;
                });
            }
        ...
        computed: {
            dataExist() {
                return this.blockSummary != undefined;
            }
        },
        components: {
            a4: PageA4
