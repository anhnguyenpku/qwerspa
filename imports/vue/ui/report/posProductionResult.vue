<!--suppress ALL -->
<template>
    <div class="posProductionResult-report">
        <a4>
...
<div class="row"
  ...
  <p class="row"
     style="text-align: center !important;font-family:'Khmer OS Battambang';font-size: 11 !important;">
                ...
                <tbody style="margin-bottom: 5px;" v-html="productionResultHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posProductionResultReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
                        this.productionResultHtml = result.productionResultHTML;
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['productionResult'];
                return data;
            }
        },
        components: {
