<!--suppress ALL -->
<template>
    <div class="schBusPayment-report">
        <a4>
            ...
            <span slot="content" style="margin: 0px !important;">
                ...
                <tbody style="margin-bottom: 5px;" v-html="busPaymentHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('schBusPaymentReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
                        this.busPaymentHtml = result.busPaymentHTML;
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['busPayment'];
                return data;
            }
        },
        components: {
