<!--suppress ALL -->
<template>
    <div class="posProductionResultSummmary-report">
        <a4>
...
<div class="row"
  ...
  <p class="row"
     style="text-align: center !important;font-family:'Khmer OS Battambang';font-size: 11 !important;">
                ...
                <tbody style="margin-bottom: 5px;" v-html="productionResultSummaryHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posProductionResultSummaryReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
                        this.productionResultSummaryHtml = result.productionResultSummaryHTML;
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['productionResultSummary'];
                return data;
            }
        },
        components: {
