<!--suppress ALL -->
<template>
    <div class="posProduction-report">
        <a4>
                                ...
                                <el-row type="flex" class="row-bg" justify="center">
                                    ...
                                    <el-col>
                                        <el-form-item :label="langConfig['status']">
                                            <el-select filterable v-model="params.statusId" clearable
                                                       :placeholder="langConfig['all']"
                                                       style="width: 95%">
                                                <el-option
  ...
  <p class="row"
     style="text-align: center !important;font-family:'Khmer OS Battambang';font-size: 11 !important;">
                ...
                <thead style="margin-top: 5px">
                    <tr>
                        <th>{{langConfig['no']}}</th>
                        <th>{{langConfig['productionName']}}</th>
                ...
                <tbody style="margin-bottom: 5px;" v-html="productionHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posProductionReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
                        this.productionHtml = result.productionHTML;
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['production'];
                return data;
            }
        },
        components: {
