<!--suppress ALL -->
<template>
    <div class="posConvertInventory-report">
        <a4>
...
<div class="row"
  ...
  <p class="row"
     style="text-align: center !important;font-family:'Khmer OS Battambang';font-size: 11 !important;">
                ...
                <tbody style="margin-bottom: 5px;" v-html="convertInventoryHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posConvertInventoryReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
                        this.convertInventoryHtml = result.convertInventoryHTML;
