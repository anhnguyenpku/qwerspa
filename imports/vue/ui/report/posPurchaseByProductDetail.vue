<!--suppress ALL -->
<template>
    <div class="posPurchaseByProductDetail-report">
        <a4>
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posPurchaseByProductDetailReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
        ...
        computed: {
            dataExist() {
                // return this.posPurchaseData.length > 0;
            },
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['purchaseByProductDetail'];
                return data;
            }
        },
        components: {
