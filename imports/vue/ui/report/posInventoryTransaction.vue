<!--suppress ALL -->
<template>
    <div class="posInventoryTransaction-report">
        <a4>
                    ...
                    <el-col :span="24">
                        <el-card class="box-card">
                            <div slot="header" class="clearfix">
                                <span>{{langConfig['titleFilter']}} <i class="header-icon el-icon-information"></i></span>
     ...
     alt="">
                ...
                <thead style="margin-top: 5px">
                    <tr>
                        ...
                        <th>{{langConfig['qtyEnding']}}</th>
                        <th>{{langConfig['averageCost']}}</th>
                        <th>{{langConfig['amountEnding']}}</th>
                    </tr>
                </thead>
                <tbody style="margin-bottom: 5px;" v-html="inventoryTransactionHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posInventoryTransactionReport', this.params, this.langConfig, (err, result) => {

                    if (result) {
                        this.inventoryTransactionHtml = result.inventoryTransactionHTML;
        ...
        computed: {
            dataExist() {
                ...
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['inventoryTransaction'];
                return data;
            }
        },
        components: {
