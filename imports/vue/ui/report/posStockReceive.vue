<!--suppress ALL -->
<template>
    <div class="posStockReceive-report">
        <a4>
     ...
     style="text-align: center !important;font-family:'Khmer OS Battambang';font-size: 11 !important;">
                ...
                <thead style="margin-top: 5px">
                    <tr>
                        ...
                        <th>{{langConfig['profit']}}</th>
                        <th>{{langConfig['profitBalance']}}</th>
                    </tr>
                </thead>
                <tbody style="margin-bottom: 5px;" v-html="stockReceiveHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posStockReceiveReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
                        this.stockReceiveHtml = result.stockReceiveHTML;
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['stockReceive'];
                return data;
            }
        },
        components: {
