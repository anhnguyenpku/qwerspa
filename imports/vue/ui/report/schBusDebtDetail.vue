<!--suppress ALL -->
<template>
    <div class="schBusDebtDetail-report">
        <a4>
            ...
            <span slot="content" style="margin: 0px !important;">
                ...
                <tbody style="margin-bottom: 5px;" v-html="busDebtDetailHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('schBusDebtDetailReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
                        this.busDebtDetailHtml = result.busDebtDetailHTML;
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['busDebtDetail'];
                return data;
            }
        },
        components: {
