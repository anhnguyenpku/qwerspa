<!--suppress ALL -->
<template>
    <div class="posSaleByCustomerDetail-report">
        <a4>
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posSaleByCustomerDetailReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['saleByCustomerDetail'];
                return data;
            }
        },
        components: {
