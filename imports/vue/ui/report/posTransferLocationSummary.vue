<!--suppress ALL -->
<template>
    <div class="posTransferLocationSummary-report">
        <a4>
                        ...
                        <el-card class="box-card">
                            ...
                            <el-form :label-position="labelPosition">
                                <el-row type="flex" class="row-bg" justify="center">
                                    ...
                                    <el-col>
                                        <el-form-item :label="langConfig['locationFrom']">
                                            <el-select filterable v-model="params.locationFromId" clearable
                                                       :placeholder="langConfig['all']"
                                                       style="width: 95%">
                                                <el-option
                                    ...
                                    <el-col>
                                        <el-form-item :label="langConfig['locationTo']">
                                            <el-select filterable v-model="params.locationToId" clearable
                                                       :placeholder="langConfig['all']"
                                                       style="width: 95%">
                                                <el-option
                                                        v-for="item in locationOptions"
...
<div class="row"
  ...
  <p class="row"
     style="text-align: center !important;font-family:'Khmer OS Battambang';font-size: 11 !important;">
                ...
                <tbody style="margin-bottom: 5px;" v-html="transferLocationSummaryHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posTransferLocationSummaryReport', this.params, this.langConfig, (err, result) => {

                    if (result) {
                        this.transferLocationSummaryHtml = result.transferLocationSummaryHTML;
        ...
        computed: {
            dataExist() {
                ...
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['transferLocationSummary'];
                return data;
            }
        },
        components: {
