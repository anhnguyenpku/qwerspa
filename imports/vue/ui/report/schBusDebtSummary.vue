<!--suppress ALL -->
<template>
    <div class="schBusDebtSummary-report">
        <a4>
            ...
            <span slot="content" style="margin: 0px !important;">
                ...
                <tbody style="margin-bottom: 5px;" v-html="busDebtSummaryHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('schBusDebtSummaryReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
                        this.busDebtSummaryHtml = result.busDebtSummaryHTML;
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['busDebtSummary'];
                return data;
            }
        },
        components: {
