<!--suppress ALL -->
<template>
    <div class="posCollectionSheetDetail-report">
        <a4>
...
<img style="width: 70px;height: 70px;float: left !important;"
     ...
     alt="">
                ...
                <thead style="margin-top: 5px">
                    <tr>
                        <th>{{langConfig['no']}}</th>
                        <th>{{langConfig['customerName']}}</th>
                        <th>{{langConfig['phoneNumber']}}</th>
                        <th>{{langConfig['dueDate']}}</th>
                        <th>{{langConfig['dayOverDue']}}</th>
                        <th>{{langConfig['amountNeedToPay']}}</th>
                    </tr>
                </thead>
                <tbody style="margin-bottom: 5px;" v-html="collectionSheetHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posCollectionSheetDetailReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
                        this.collectionSheetHtml = result.collectionSheetHTML;
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['collectionSheetDetail'];
                return data;
            },
            dataExist() {
