<!--suppress ALL -->
<template>
    <div class="posSaleOrderByCustomerDetail-report">
        <a4>
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posSaleOrderByCustomerDetailReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['saleOrderByCustomerDetail'];
                return data;
            }
        },
        components: {
