...
<template>
  ...
  <p class="row"
     style="text-align: center !important;font-family:'Khmer OS Battambang';font-size: 11 !important;">
                ...
                <tbody style="margin-bottom: 5px;" v-html="fixedAssetHtml">
                </tbody>
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('fixedAssetReport', this.params, (err, result) => {
                    if (result) {
                        this.fixedAssetsData = result.fixedAssetList;
                        this.fixedAssetHtml = result.fixedAssetHtml;
        ...
        computed: {
            dataExist() {
                return this.fixedAssetsData.length > 0;
            }
        },
        components: {
            a4: PageA4
