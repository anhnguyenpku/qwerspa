<!--suppress ALL -->
<template>
    <div class="unpaid-customer-report">
        <a4>
            <div slot="header">
    ...
    export default {
        ...
        methods: {
            ...
            getInvoiceType(newReadingDate) {
                let add24days = moment(newReadingDate).startOf('days').add(this.waterBillingSetup.invoiceExpiredAfter - 1, 'days').format('YYYY-MM-DD');
            ...
            handleRun() {
                ...
                Meteor.call('unpaidCustomerReport', this.params, selector2, (err, result) => {
                    if (result) {
