<!--suppress ALL -->
<template>
    <div class="posPurchaseByVendorDetail-report">
        <a4>
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posPurchaseByVendorDetailReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['purchaseByVendorDetail'];
                return data;
            }
        },
        components: {
