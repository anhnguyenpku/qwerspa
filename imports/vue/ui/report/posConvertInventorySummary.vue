<!--suppress ALL -->
<template>
    <div class="posConvertInventorySummary-report">
        <a4>
     ...
     alt="">
                ...
                <thead style="margin-top: 5px">
                    <tr>
                        ...
                        <th colspan="2">{{langConfig['convert']}}</th>
                    </tr>
                </thead>
                <tbody style="margin-bottom: 5px;" v-html="convertInventorySummayHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posConvertInventorySummaryReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
                        this.convertInventorySummayHtml = result.convertInventorySummaryHTML;
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['convertInventory'];
                return data;
            }
        },
        components: {
