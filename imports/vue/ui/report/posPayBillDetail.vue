<!--suppress ALL -->
<template>
    <div class="posPayBillDetail-report">
        <a4>
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posPayBillDetailReport', this.params, this.langConfig, (err, result) => {
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['payBillDetail'];
                return data;
            }
        },
        components: {
