<!--suppress ALL -->
<template>
    <div class="posInvoiceByImei-report">
        <a4>
                        ...
                        <el-card class="box-card">
                            ...
                            <el-form :label-position="labelPosition">
                                <el-row type="flex" class="row-bg" justify="center">
                                    ...
                                    <el-col>
                                        <el-form-item :label="langConfig['imei']">
                                            <el-input
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                if (this.params.imei == "" || this.params.imei == undefined) {
                    alertify.error("Imei can't not empty!!");
                    this.loading = false;
                    return false;
                }
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['invoiceByImei'];
                return data;
            }
        },
        components: {
