<!--suppress ALL -->
<template>
    <div class="posInventoryEnding-report">
        <a4>
...
<img style="width: 70px;height: 70px;float: left !important;"
     ...
     alt="">
                ...
                <tbody style="margin-bottom: 5px;" v-html="inventoryEndingHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posInventoryEndingReport', this.params, this.langConfig, (err, result) => {

                    if (result) {
                        this.inventoryEndingHtml = result.inventoryEndingHTML;
        ...
        computed: {
            dataExist() {
                ...
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['inventoryEnding'];
                return data;
            }
        },
        components: {
