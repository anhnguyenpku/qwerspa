<!--suppress ALL -->
<template>
    <div class="posPurchaseSaleByProductSummary-report">
        <a4>
...
<img style="width: 70px;height: 70px;float: left !important;"
     ...
     alt="">
                ...
                <tbody style="margin-bottom: 5px;" v-html="purchaseSaleHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posPurchaseSaleByProductSummaryReport', this.params, this.langConfig, (err, result) => {
                    if (result) {
                        this.purchaseSaleHtml = result.purchaseSaleHTML;
        ...
        computed: {
            dataExist() {
                // return this.posPurchaseSaleData.length > 0;
            },
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['purchaseSaleByProductSummary'];
                return data;
            }
        },
        components: {
