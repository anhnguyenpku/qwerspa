<!--suppress ALL -->
<template>
    <div class="posDebtDetail-report">
        <a4>
...
<img style="width: 70px;height: 70px;float: left !important;"
     ...
     alt="">
                ...
                <tbody style="margin-bottom: 5px;" v-html="debtHtml">
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posDebtDetailReport', this.params, this.langConfig, (err, result) => {

                    if (result) {
                        this.debtHtml = result.debtHTML;
        ...
        computed: {
            dataExist() {
                ...
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['debtDetail'];
                return data;
            }
        },
        components: {
