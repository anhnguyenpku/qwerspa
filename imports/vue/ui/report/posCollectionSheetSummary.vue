<!--suppress ALL -->
<template>
    <div class="posCollectionSheetSummary-report">
        <a4>
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posCollectionSheetSummaryReport', this.params, this.langConfig, (err, result) => {
        ...
        computed: {
            dataExist() {
                ...
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['collectionSheetSummary'];
                return data;
            }
        },
        components: {
