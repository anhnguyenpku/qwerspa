<!--suppress ALL -->
<template>
    <div class="posInvoiceReceiveItemPrintA4-report">
        <a4>
                      ...
                      <caption style="padding-top: 0px !important;">
                          <div class="row">
                              ...
                              <span style="text-align: center !important;font-size: 15px; border: 0px !important; float: right">
                                  <p style="font-family: 'Khmer OS Muol' !important;">វិក័យបត្រកាត់ទំនិញ</p>
                                  <p>Invoice</p>
                                  <p class="invoiceNo">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{invoiceDoc && invoiceDoc.invoiceNo || ""}}</p>
                              </span>
                              </div>
                          </div>
                          <br>
...
<script>
    ...
    export default {
        ...
        methods: {
            handleRun(invoiceId) {
                this.loading = true;
                Meteor.call('posInvoiceReceiveItemPrintA4Report', invoiceId, this.langConfig, (err, result) => {
                    if (result) {
