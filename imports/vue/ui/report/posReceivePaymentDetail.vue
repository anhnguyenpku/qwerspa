<!--suppress ALL -->
<template>
    <div class="posReceivePaymentDetail-report">
        <a4>
    ...
    export default {
        ...
        methods: {
            ...
            handleRun() {
                ...
                Meteor.call('posReceivePaymentDetailReport', this.params, this.langConfig, (err, result) => {
        ...
        computed: {
            ...
            langConfig() {
                let data = compoLangReport.filter(config => config.lang === this.langSessionReport)[0]['receivePaymentDetail'];
                return data;
            }
        },
        components: {
