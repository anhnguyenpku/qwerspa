    ...
    <div class="print-posted-meter-reading">
        ...
        <div class="A4">
            ...
            <div v-for="doc in reportData">
                <div class="sheet "
                     style="padding-left: 10px;padding-right: 10px;margin-top: 3.4cm;page-break-after:always; overflow:none;">
                    <table width="100%">
                        <tbody>
                        <tr style="border: 0px;">
                            <th colspan="3"
                            ...
                            <th colspan="5" class="postInvoiceTh"
                                style="padding-top: 5px; padding-bottom: 10px;font-size: 13px;padding-left: 10px;">
                                {{doc.customerDoc._id}}
                            </th>
                        ...
                        <tr style="border: 0px;">
                            ...
                            <th colspan="5" class="postInvoiceTh"
                                ...
                                {{doc.waterBillingDoc.enShortName}}{{doc.sumBarcode || doc.barcode}}
                            </th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="4" style="text-align: center; padding-left: 50px">
                                {{(doc.hasOldMeterWaterConsumption && doc.meterChangeType && doc.meterChangeType ==
                                'Meter Reset') ? doc.oldPrevReading : doc.prevReading}}
                            </td>
                        ...
                        <slot v-if="doc.hasOldMeterWaterConsumption && doc.meterChangeType && doc.meterChangeType=='Meter Change'">
                            <tr class="fz9">
                                ...
                                <!-- <td colspan="6" style="font-family: 'Khmer OS System'; font-size: 9px">
                                 </td>-->
                                <td colspan="5"
                        ...
                        <slot v-else-if="doc.hasOldMeterWaterConsumption && doc.meterChangeType && doc.meterChangeType=='Meter Reset'">
                            <tr class="fz9">
                                ...
                                <td colspan="15"
                                    style="font-family: 'Khmer OS System'; font-size: 9px !important; padding-left: 0px;">
                                    នាឡិកាវិលជំុ
                                </td>
                                <td colspan="5"
                        ...
                        <tr class="fz9">
                            ...
                            <td colspan="15"
                                ...
                                {{ doc.isEstimated ? "តម្លៃទឹកតាមការប៉ាន់ស្មានកំរិត" :
                                "តម្លៃទឹកតាមនាឡិកាស្ទង់កំរិត"}}{{doc.level | switchNumToKh}}
                            ...
                            <td colspan="5"
                                style="text-align: right;font-family: 'Khmer OS System'; font-size: 9px; padding-right: 20px;">
                                {{numFormatter(doc.price)}}
                            </td>
                        ...
                        <tr class="fz9">
                            ...
                            <td colspan="5"
                                style="text-align: right;font-family: 'Khmer OS System'; font-size: 9px !important; padding-right: 20px;">
                                {{doc.maintenanceFee | numFormatRiel}}
                            </td>
                            <td colspan="6" style="text-align: right;font-family: 'Khmer OS System'; font-size: 9px">
                                {{doc.maintenanceFee | numFormatRiel}}
                            </td>
                        ...
                        <tr class="fz9">
                            ...
                            <!--<td colspan="7" style="font-family: 'Khmer OS System'; font-size: 9px"></td>-->
                            <td colspan="5"
                                style="text-align: right;font-family: 'Khmer OS System'; font-size: 9px !important">
                                {{doc.waterConsumption}} M3
                            </td>
                        ...
                        <tr style="margin: 0px">
                            ...
                            <th colspan="10" style="text-align: right; height: 38px;padding-bottom: 0px !important"
                                class="body-border-no-left">
                                {{numFormatter((doc.balance+ doc.oldBalance))}}
                            </th>
                        </tr>
                        </tbody>
                        ...
                        <tr style="height: 6px; padding: 0px ;vertical-align: bottom !important;">
                            ...
                            <td colspan="29" class="fz8"
                                ...
                                <span style="position: absolute;bottom: 150px;right: 14px;z-index: 999999;font-size: 9px">  {{doc.waterConsumption}} M3</span>
                            </td>
                        </tr>
                        <tr style="border: 0">
                            ...
                            <th colspan="9"
                                ...
                                style="font-family: Khmer OS Battambang;font-size: 12px;padding-bottom: 5px; padding-top: 5px; padding-left: 15px  !important;"
                                valign="middle"
                            >
                        ...
                        <tr style="border: 0px;padding-bottom:0px;">
                            <td style="border: 0px;padding-bottom: 15px; padding-top: 0px;" colspan="4"
                                class="postInvoiceTh10">
                                <span class="no-print">លេខសំគាល់ទីតាំង<br>Delivery Point Code</span>
                            </td>
                            <td style="border: 0px;text-align: center;padding-bottom: 15px; padding-top:0px;padding-left: 20px"
                                colspan="9"
                                valign="middle"
                                class="headin-no-border postInvoiceTh10">{{isOldBlockExist(doc)}}
                            </td>
                            ...
                            <th colspan="4" class="postInvoiceTh10"
                                style="padding-bottom: 15px; padding-top: 0px;padding-left: 55px;text-align: left">
                                {{addDays(doc.newReadingDate,'25')}}
                            </th>
                        ...
                        <tbody>
                        <tr>
                            <td colspan="33" style="font-family:'Khmer OS System'; font-size: 3px;"></td>
                        </tr>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <el-form :rules="rules" ref="postedInvoice" :label-position="labelPosition"
                                    ...
                                    <!--<el-form-item label="Print QTY">-->
                                    <!--<el-select v-model="limit" placeholder="Select">-->
                                    <!--<el-option v-for="item in limitOptions" :key="item.value"-->
                                    <!--:label="item.label" :value="item.value">-->
                                    <!--</el-option>-->
                                    <!--</el-select>-->
                                    <!--</el-form-item>-->
                                    <!--<el-form-item label="Print Count">-->
                                    <!--<el-select v-model="printedCount" placeholder="Select">-->
                                    <!--<el-option v-for="item in printedCountOptions" :key="item.value"-->
                                    <!--:label="item.label" :value="item.value">-->
                                    <!--</el-option>-->
                                    <!--</el-select>-->
                                    <!--</el-form-item>-->
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            addDays(date, amount) {
                return moment(date).add(amount, 'days').format('DD/MM/YYYY');
            },
            styleForRow(doc) {
                let height = '230px';
            ...
            trunWord(val) {
                return _.truncate(val, {'length': 30,});
            },
            /* calculateBalance(doc){
                Meteor.call('getDebtPayment',doc.customerId,doc._id,doc.rolesArea,(err,result)=>{
                    if(result){
                        this.balance= result;
                    }else {
                        this.balance= 0;
                ...
                return this.balance == 0 ? "-": numeral(this.balance).format('0,0');
            },
           calculateBalance(row) {
                ...
                return balance == 0 ? "-": numeral(Math.abs(balance - currentTotal)).format('0,0');
            },*/
