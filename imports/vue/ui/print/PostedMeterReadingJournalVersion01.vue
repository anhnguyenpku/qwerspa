    ...
    <div class="print-posted-meter-reading">
        ...
        <div class="A4">
            ...
            <div v-for="doc in reportData">
                <div class="sheet "
                     style="padding-left: 10px;padding-right: 10px;margin-top: 3.25cm;page-break-after:always; overflow:none;">
                    <table width="100%">
                        <tbody>
                        <tr style="border: 0px;">
                            <th colspan="3"
                        ...
                        <tr style="height: 6px; padding: 0px ;vertical-align: bottom !important;">
                            ...
                            <td colspan="29" class="fz8"
                               ...
                               <span style="position: absolute;bottom: 148px;right: 14px;z-index: 999999;">  {{doc.waterConsumption}} M3</span>
                            </td>
                        </tr>
                        <tr style="border: 0">
                        ...
                        <tr style="border: 0px;padding-bottom:0px;">
                            ...
                            <td style="border: 0px;text-align: center;padding-bottom: 15px; padding-top:0px;padding-left: 20px"
                                colspan="9"
                                valign="middle"
                                class="headin-no-border postInvoiceTh10">{{isOldBlockExist(doc.customerDoc)}}
                            </td>
                            ...
                            <th colspan="4" class="postInvoiceTh10"
                                style="padding-bottom: 15px; padding-top: 0px;padding-left: 55px;text-align: left">{{addDays(doc.newReadingDate,'25')}}
                            </th>
