    ...
    <div class="sch_program">
        ...
        <el-dialog
            ...
            <el-form :model="schProgramForm" :rules="rules" ref="schProgramFormAdd" label-width="120px"
                ...
                <el-row class="pull-right">
                    <el-button @click="dialogAddSchProgram = false, cancel()">{{langConfig['cancel']}} <i>(ESC)</i></el-button>
                    <el-button type="primary" @click="saveSchProgram($event)">{{langConfig['save']}} <i>(Ctrl + Enter)</i></el-button>
                </el-row>
                <br>
            </el-form>
        </el-dialog>
        ...
        <el-dialog
            ...
            <el-form :model="schProgramForm" :rules="rules" ref="schProgramFormUpdate" label-width="120px"
                ...
                <hr style="margin-top: 0px !important;">
                <el-row class="pull-right">
                    <el-button @click="dialogUpdateSchProgram = false ,cancel()">{{langConfig['cancel']}} <i>(ESC)</i></el-button>
                    <el-button type="primary" @click="updateSchProgram">{{langConfig['save']}} <i>(Ctrl + Enter)</i></el-button>
                </el-row>
                <br>
            </el-form>
        </el-dialog>
...
<script>
    ...
    import {Sch_ProgramReact} from "../../collection/schProgram";
    ...
    export default {
        ...
        created() {
            ...
            this.fetchUser();
            this.queryData();
            Meteor.subscribe('Sch_ProgramReact');
