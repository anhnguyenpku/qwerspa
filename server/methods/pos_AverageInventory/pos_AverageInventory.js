            ...
            if (data && data.convert.length > 0) {
                data.convert.forEach((doc) => {
                    ...
                    objTo = {
                        ...
                        amountEnding: (onHandInventoryTo && onHandInventoryTo.amountEnding || 0) + ((onHandInventoryTo && onHandInventoryTo.averageCost || 0) * doc.qty),
                        qtyEnding: (onHandInventoryTo && onHandInventoryTo.qtyEnding || 0) + doc.qty,
                        averageCost: (onHandInventoryTo && onHandInventoryTo.qtyEnding || 0) + doc.qty === 0 ? 0 : ((onHandInventoryTo && onHandInventoryTo.amountEnding || 0) + ((onHandInventoryTo && onHandInventoryTo.averageCost || 0) * doc.qty)) / ((onHandInventoryTo && onHandInventoryTo.qtyEnding || 0) + doc.qty),
