...
Meteor.methods({
    posProductionSummaryReport(params, translate) {
        let parameter = {};
        ...
        let productionSummaryList;
        let productionSummaryHTML = "";
        let total = 0;
        //Range Date
        productionSummaryList = Pos_Production.aggregate([
        ...
        if (productionSummaryList.length > 0) {
            let ind = 1;
            productionSummaryList.forEach((obj) => {
        ...
        data.productionSummaryHTML = productionSummaryHTML;
        return data;
    }
})
;
